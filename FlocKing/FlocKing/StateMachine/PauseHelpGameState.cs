...
{
    class PauseHelpGameState : IBaseState
    {
        ...
        Texture2D pauseHelpGameTexture;
        ...
        public void Enter()
        {
            ...
            pauseHelpGameTexture = content.Load<Texture2D>("Textures\\StartButtonScreen");

            textureRect = new Rectangle(0, 0, pauseHelpGameTexture.Width, pauseHelpGameTexture.Height);
        }
        ...
        public bool Input()
        {
            ...
            for (int i = 0; i < 4; i++, index++)
            {
                ...
                if (gamePad.IsButtonDown(Buttons.B) || gamePad.IsButtonDown(Buttons.X) || gamePad.IsButtonDown(Buttons.Y) ||
                    gamePad.IsButtonDown(Buttons.A))
                {
                    // Go back
                    Console.WriteLine("Get out of pause help screen");
        ...
        public void Render()
        {
            ...
            Game1.Instance.spriteBatch.Draw(pauseHelpGameTexture, textureRect, color);
